    ...
    <div className="py-10 px-4">
      ...
      <div className="flex mt-10 justify-around">
        <div className="flex flex-col items-center">
          ...
          <span className="mt-2 text-sm font-mono text-gray-800">판매내역</span>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
            <svg
          ...
          <span className="mt-2 text-sm font-mono text-gray-800">구매내역</span>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
            <svg
          ...
          <span className="mt-2 text-sm font-mono text-gray-800">관심목록</span>
        </div>
      </div>
      <div className="mt-12">
