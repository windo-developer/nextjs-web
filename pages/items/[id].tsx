        ...
        <div className="mb-8">
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center justify-between space-x-2">
              <button className="flex-1 bg-orange-500 text-white py-3 rounded-md shadow-sm font-medium hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                Talk to seller
              </button>
              <button className="flex p-3 items-center justify-center text-gray-400 rounded-md hover:bg-gray-100 hover:text-gray-500">
                <svg
                  className="h-6 w-6 "
